<template>
    <div class="z-50">
        <!-- Purple banner -->
        <div v-show="showPurpleBanner && !isScrolled" class="bg-[#5624d0] text-white px-4 py-2 flex justify-between items-center text-sm">
        ...
        <!-- White navbar (visible initially, hidden after scrolling) -->
        <div v-show="!isScrolled" class="px-4 py-2 bg-white border-b border-gray-200">
            <div class="flex items-center gap-4 mx-auto px-12">
